...
class PosterStudio extends JGApp {
  ...
  #toolbar() {
    this.$('#bar').items = [
      ...
      { separator: true },
      { id: 'delete', label: t('poster-studio.delete', 'Delete'), icon: 'eraser', iconOnly: true, danger: true, title: t('poster-studio.deleteTheSelection', 'Delete the selection'), action: () => this.#remove() },
      { spacer: true },
