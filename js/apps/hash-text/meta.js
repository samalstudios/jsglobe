export default {
  ...
  i18n: {
    ...
    fr: { name: 'Hachage de texte', tagline: 'Empreintes MD5, SHA-1, SHA-256, SHA-512' },
    pt: { name: 'Hash de texto', tagline: 'Resumos MD5, SHA-1, SHA-256, SHA-512' },
    ja: { name: 'テキストのハッシュ', tagline: 'MD5、SHA-1、SHA-256、SHA-512 のダイジェスト' },
    ko: { name: '텍스트 해시', tagline: 'MD5, SHA-1, SHA-256, SHA-512 다이제스트' },
  },
