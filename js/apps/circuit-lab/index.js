...
class CircuitLab extends JGApp {
  ...
  renderApp() {
    ...
    this.$('#bar').items = [
      ...
      { id: 'delete', label: t('circuit-lab.delete', 'Delete'), icon: 'eraser', iconOnly: true, title: t('circuit-lab.deleteTheSelectedPart', 'Delete the selected part'), action: () => this.#remove() },
      { spacer: true },
