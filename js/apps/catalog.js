...
export const catalog = [
  ...
  },
  {
    ...
    load: () => import('./serial-console.js'),
  },
  {
    id: 'bluetooth-scanner',
    name: 'Bluetooth',
    tagline: 'Browse GATT services on a nearby device',
    category: 'utility',
    glyph: 'B',
    icon: 'bluetooth',
    tint: '#3f6b91',
    keywords: ['bluetooth', 'ble', 'gatt', 'device', 'scanner', 'characteristic', 'service'],
    tag: 'jg-app-bluetooth-scanner',
    window: { width: 900, height: 780 },
    load: () => import('./bluetooth-scanner.js'),
  },
  {
    id: 'gamepad-tester',
    name: 'Gamepad Tester',
